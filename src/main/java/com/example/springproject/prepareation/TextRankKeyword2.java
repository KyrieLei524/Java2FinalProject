...
public class TextRankKeyword2 extends KeywordExtractor {

    public static Map<String, Float> getTerm_Rank(String document, int size) {
    ...
    public TextRankKeyword2(Segment defaultSegment) {
        super(defaultSegment);
    }

    public TextRankKeyword2() {
    }
    ...
    public static float sigMoid(float value) {
        return (float)(1.0 / (1.0 + Math.exp((double)(-value))));
    }
